...
import com.cj.annotations.MODULE_INFO_PRE
import com.cj.annotations.module.model.ModuleInfoEntity
...
object ModuleManager {
    ...
    fun loadModules() {
        ...
        try {
            ...
            delegateList!!.addAll(getObjectsWithClassName(IModuleDelegate::class.java,delegateNameList))
